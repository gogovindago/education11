...
public class MostFoursAdapter extends RecyclerView.Adapter<MostFoursAdapter.ViewHolder> {


    ArrayList<BannerResponse.MostFour> mValues = new ArrayList<BannerResponse.MostFour>();
    Context mContext;
    protected ItemListener mListener;
    int currposition;

    public MostFoursAdapter(Context context, ArrayList values, ItemListener itemListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(BannerResponse.MostFour item, int currposition) {
           ...
           /* if (currposition % 2 == 0) {
            ...
            topbatingStrrate.setText(item.getFours());
//            topbatingScore.setText(item.getWickets());
//
//            topbatingAvg.setText(item.getBowlAverage());
//            
        ...
        public void onClick(View view) {
            if (mListener != null) {
                mListener.onMostFourItemClick(item, currposition);
            }
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_view_item_most_sixes_fours_row, parent, false);
    ...
    public interface ItemListener {
        void onMostFourItemClick(BannerResponse.MostFour item, int currposition);
    }
}