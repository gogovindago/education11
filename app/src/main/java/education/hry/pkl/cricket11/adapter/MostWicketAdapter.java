...
public class MostWicketAdapter extends RecyclerView.Adapter<MostWicketAdapter.ViewHolder> {


    ArrayList<BannerResponse.MostWicket> mValues = new ArrayList<BannerResponse.MostWicket>();
    Context mContext;
    protected ItemListener mListener;
    int currposition;

    public MostWicketAdapter(Context context, ArrayList values, ItemListener itemListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        BannerResponse.MostWicket item;
        ...
        public void setData(BannerResponse.MostWicket item, int currposition) {
        ...
        public void onClick(View view) {
            if (mListener != null) {
                mListener.onMostWicketItemClick(item, currposition);
            }
        }
    }
    ...
    public interface ItemListener {
        void onMostWicketItemClick(BannerResponse.MostWicket item, int currposition);
    }
}