...
public class MostSixesAdapter extends RecyclerView.Adapter<MostSixesAdapter.ViewHolder> {


    ArrayList<BannerResponse.MostSix> mValues = new ArrayList<BannerResponse.MostSix>();
    Context mContext;
    protected ItemListener mListener;
    int currposition;

    public MostSixesAdapter(Context context, ArrayList values, ItemListener itemListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(BannerResponse.MostSix item, int currposition) {
           ...
           /* if (currposition % 2 == 0) {
            ...
            topbatingStrrate.setText(item.getSixes());
...
//
        ...
        public void onClick(View view) {
            if (mListener != null) {
                mListener.onMostSixItemClick(item, currposition);
            }
        }
    }
    ...
    public interface ItemListener {
        void onMostSixItemClick(BannerResponse.MostSix item, int currposition);
    }
}