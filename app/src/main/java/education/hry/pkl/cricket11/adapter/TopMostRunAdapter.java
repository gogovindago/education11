...
public class TopMostRunAdapter extends RecyclerView.Adapter<TopMostRunAdapter.ViewHolder> {


    ArrayList<BannerResponse.MostRun> mValues = new ArrayList<BannerResponse.MostRun>();
    Context mContext;
    protected ItemListener mListener;
    int currposition;

    public TopMostRunAdapter(Context context, ArrayList values, ItemListener itemListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(BannerResponse.MostRun item, int currposition) {
           ...
           //txtName.setText(item.getPlayerName());
            ...
            topbatingScore.setText(item.getRuns());
        ...
        public void onClick(View view) {
            if (mListener != null) {
                mListener.onMostRuntingAvgItemClick(item, currposition);
            }
        }
    }
    ...
    public interface ItemListener {
        void onMostRuntingAvgItemClick(BannerResponse.MostRun item, int currposition);
    }
}