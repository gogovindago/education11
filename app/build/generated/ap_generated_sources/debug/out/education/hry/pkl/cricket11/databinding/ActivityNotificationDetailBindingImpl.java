...
public class ActivityNotificationDetailBindingImpl extends ActivityNotificationDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.end_padding, 6);
    }
    // views
    @NonNull
    ...
    public ActivityNotificationDetailBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ActivityNotificationDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
